...
distclean : clean
	rm -f ${SRC_DIR}/Absyn.C ${SRC_DIR}/Absyn.H ${SRC_DIR}/Test.C ${SRC_DIR}/Parser.C ${SRC_DIR}/Parser.H ${SRC_DIR}/Lexer.C ${SRC_DIR}/Typechecker.C ${SRC_DIR}/CodeGen.C ${SRC_DIR}/CodeGen.H ${SRC_DIR}/Typechecker.H ${SRC_DIR}/Printer.C ${SRC_DIR}/Printer.H Makefile ${SRC_DIR}/Javalette.l ${SRC_DIR}/Javalette.y ${SRC_DIR}/Javalette.tex
...
${SRC_DIR}/Test.o : ${SRC_DIR}/Test.C ${SRC_DIR}/Parser.H ${SRC_DIR}/Printer.H ${SRC_DIR}/Absyn.H ${SRC_DIR}/Typechecker.H ${SRC_DIR}/CodeGen.H
