...
FLEX=flex
FLEX_OPTS=-PJavalette

BISON=bison
BISON_OPTS=-t -pJavalette

OBJS=${SRC_DIR}/Absyn.o ${SRC_DIR}/Lexer.o ${SRC_DIR}/Parser.o ${SRC_DIR}/Printer.o
...
clean :
	rm -f *.o j ${SRC_DIR}/Javalette.aux ${SRC_DIR}/Javalette.log ${SRC_DIR}/Javalette.pdf ${SRC_DIR}/Javalette.dvi ${SRC_DIR}/Javalette.ps ${SRC_DIR}/Javalette

distclean : clean
	rm -f ${SRC_DIR}/Absyn.C ${SRC_DIR}/Absyn.H ${SRC_DIR}/Test.C ${SRC_DIR}/Parser.C ${SRC_DIR}/Parser.H ${SRC_DIR}/Lexer.C ${SRC_DIR}/Skeleton.C ${SRC_DIR}/Skeleton.H ${SRC_DIR}/Printer.C ${SRC_DIR}/Printer.H Makefile ${SRC_DIR}/Javalette.l ${SRC_DIR}/Javalette.y ${SRC_DIR}/Javalette.tex

jlc : ${OBJS} Test.o
	@echo "Linking jlc..."
	${CC} ${CCFLAGS} ${OBJS} Test.o -o jlc
...
Test.o : ${SRC_DIR}/Test.C ${SRC_DIR}/Parser.H ${SRC_DIR}/Printer.H ${SRC_DIR}/Absyn.H
