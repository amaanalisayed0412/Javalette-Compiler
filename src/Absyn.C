...
/********************   ETypeAnn    ********************/
ETypeAnn::ETypeAnn(Expr *p1, Type *p2)
{
  expr_ = p1;
  type_ = p2;
...
ETypeAnn::ETypeAnn(const ETypeAnn & other)
{
  expr_ = other.expr_->clone();
  type_ = other.type_->clone();
...
ETypeAnn &ETypeAnn::operator=(const ETypeAnn & other)
{
  ETypeAnn tmp(other);
  swap(tmp);
  return *this;
...
void ETypeAnn::swap(ETypeAnn & other)
{
  std::swap(expr_, other.expr_);
  std::swap(type_, other.type_);
...
void ETypeAnn::accept(Visitor *v)
{
  v->visitETypeAnn(this);
}
